...
<div class="tml tml-login" id="theme-my-login<?php $template->the_instance(); ?>">
	<p>If you are a SIFoCC member, you can log in here to access the Members' area.</p>
	<p>If you would like to become a member, please <a href="/contact-us">contact us</a>.</p>
	...
	<p><a href="/lostpassword/">Forgotten your password?</a></p>
</div>
