...
class Scripts implements \Dxw\Iguana\Registerable
{
    ...
    public function wpEnqueueScripts()
    {
        ...
        wp_enqueue_script('jquery', $this->getAssetPath('js/lib/jquery.min.js'));

        // Because it's awesome
        wp_enqueue_script('modernizr', $this->getAssetPath('js/lib/modernizr.min.js'));

        // Pretty much everything else should be compiled by Grunt.
        wp_enqueue_script('main', $this->getAssetPath('js/main.min.js'), ['jquery', 'modernizr'], '', true);

        wp_enqueue_style('main', $this->getAssetPath('css/main.min.css'));
    }
